...
const Skills = () => {
  // console.log(Data["skills"]["full-stack"])

  {(Data["skills"]["full-stack"]).map((hi) => {
    console.log(hi["name"]);
  });}
...
// }
  ...
  return (
    <>
      <h2 className="font-bold mt-64 text-8xl mb-32 w-full text-center md:text-6xl xs:text-4xl md:mb-16">
        Skills
      </h2>
      <div class="flex lg:flex-col flex-row justify-center items-center gap-y-32 xl:gap-y-16 md:gap-y-24 sm:gap-x-0 ">
        <div className="max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 dark:bg-gray-800 dark:border-gray-700 mr-6 lg:mx-16 md:mx-12 sm:mx-8">
          <h2 className=" text-center my-2 w-full text-4xl font-bold dark:text-light xs:text-sm">
          ...
          <ul className="my-4 space-y-3">
            {Data["skills"]["full-stack"].map((val, index) => (
              <motion.li
                key={index}
                whileHover={{ scale: 1.05 }}
        ...
        <div className="max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 dark:bg-gray-800 dark:border-gray-700 mx-6 lg:mx-16 md:mx-12 sm:mx-8">
          <h2 className=" text-center my-2 w-full text-4xl font-bold dark:text-light xs:text-sm">
            DevOps Tools
          </h2>
          <p className="text-sm font-normal text-gray-500 dark:text-gray-400">
          ...
          <ul className="my-4 space-y-3">
            {Data["skills"]["dev-ops"].map((val, index) => (
              <motion.li
                key={index}
                whileHover={{ scale: 1.05 }}
                transition={{ duration: 0.2 }}
        ...
        <div className="max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 dark:bg-gray-800 dark:border-gray-700 ml-6 lg:mx-16 md:mx-12 sm:mx-8">
          <h2 className=" text-center my-2 w-full text-4xl font-bold dark:text-light xs:text-sm">
            Other Skills
          </h2>
          <p className="text-sm font-normal text-gray-500 dark:text-gray-400">
          ...
          <ul className="my-4 space-y-3">
            {Data["skills"]["other"].map((val, index) => (
              <motion.li
                key={index}
                whileHover={{ scale: 1.05 }}
                transition={{ duration: 0.2 }}
